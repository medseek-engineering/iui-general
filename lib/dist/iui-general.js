  ...
  return {
    ...
    link: function(scope, element, attr) {
      ...
      scope.barWidth = function(bar) {
        ...
        console.log('bar.currentValue ' + bar.currentValue);
        console.log('scope.progressBarOptions.maxValue ' + scope.progressBarOptions.maxValue);
        console.log('scope.progressBarOptions.minValue ' + scope.progressBarOptions.minValue);
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/$iui-general/iui-progress-bar/iui-progress-bar.html',
    '<div class="progress">\n' +
    '  <div\n' +
    '    ng-repeat="bar in progressBarOptions.bars track by $index" \n' +
    '    role="progressbar"\n' +
    '    aria-valuenow="{{bar.currentValue}}"\n' +
    '    aria-valuemin="{{progressBarOptions.minValue}}"\n' +
    '    aria-valuemax="{{progressBarOptions.maxValue}}"\n' +
    '    style="width:{{barWidth(bar)}}%;"\n' +
    '    class="progress-bar"\n' +
    '    ng-class="bar.barStyle">\n' +
    '    <span ng-class="{ \'sr-only\' : progressBarOptions.hideLabels }">{{bar.label || barWidth(bar)}}</span>\n' +
    '  </div>\n' +
    '</div>');
}]);
})();
