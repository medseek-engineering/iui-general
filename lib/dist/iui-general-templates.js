...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/$iui-general/iui-stepper/iui-stepper.html',
    ...
    '      <button type="button" role="button" class="btn btn-default" ng-click="decrement()" ng-disabled="value < minValue">-</button>\n' +
    '    </div>\n' +
    ...
    '      <button type="button" role="button" class="btn btn-default" ng-click="increment()" ng-disabled="value > maxValue">+</button>\n' +
    '    </div>\n' +
    '  </div>\n' +
