...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/$iui-general/iui-stepper/iui-stepper.html',
    ...
    '    <span class="sr-only" ng-if="!stepperLabelDefined">Choose a number</span>\n' +
    '    {{stepperLabel}}\n' +
    '  </label>\n' +
    ...
    '    </div>\n' +
    '    <input type="number" name="stepper_value" id="stepper_value" class="stepper-button-input" ng-model="value" min="{{minValue}}" max="{{maxValue}}" step="{{incrementBy}}" />\n' +
    '    <div class="input-group-btn">\n' +
