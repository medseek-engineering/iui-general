(function () {
  ...
  describe('iui-stepper directive', function () {
    ...
    beforeEach(inject(function ($compile, $rootScope) {
      scope = $rootScope.$new();
      scope.value = 5;
      element = angular.element('<iui-stepper ng-model="value" min-value="1" max-value="99" increment-by="2" stepper-label="\'Choose a number\'"></iui-stepper>');
    ...
    describe('Form Semantics Test Suite: ', function() {
      ...
      it('should have a label present', function() {
        var label = el.find('ng-form > label');
